...
export function ProductCard({ product }: { product: ProductDto }) {
  ...
  return (
    ...
    >
      <Link href={`/urunler/${product.slug}`} className="block focus-visible:outline-2 focus-visible:outline-sky-700 focus-visible:outline-offset-2">
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        <Link href={`/urunler/${product.slug}`} className="focus-visible:outline-2 focus-visible:outline-sky-700">
